...
public class cameraController : MonoBehaviour
{
    ...
    */
    ...
    public float mainSpeed = 7.0f;   // Regular speed
    ...
    private Vector3 lastMouse = new Vector3(0, 0, 255);  // kind of in the middle of the screen, rather than at the top (play)
